...
public class ObiTriangleSkinMap : ScriptableObject
{
	...
	[HideInInspector] public int[] skinnedVertices = null;				  /**<faces list*/
	[HideInInspector] public int[] skinnedTriangles = null;				  /**<faces list*/
	[HideInInspector] public Vector3[] baryPositions = null;			  /**<faces list*/
	[HideInInspector] public Vector3[] baryNormals = null;				  /**<faces list*/
	[HideInInspector] public Vector3[] baryTangents = null;				  /**<faces list*/
	...
	private void ValidateMasterFlags(bool resetValues){
		...
		{
			if (masterFlags.Length != sourceTopology.InputMesh.vertexCount){
	...
	private void ValidateSlaveFlags(bool resetValues){
		if (targetMesh != null)
		{
			if (slaveFlags.Length != targetMesh.vertexCount){
