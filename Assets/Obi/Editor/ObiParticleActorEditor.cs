...
namespace Obi{
	...
	public abstract class ObiParticleActorEditor : Editor
	{
		...
		public virtual void OnEnable(){
			...
			particlePropertyNames = new List<string>(){"Mass","Radius"};
			...
			separatorLine.normal.background = EditorGUIUtility.Load("Obi/SeparatorLine.psd") as Texture2D;
		...
		static void CreateParticleMaterials() {
			if (!particleMaterial) { 
				particleMaterial = ObiEditorUtils.GetRequiredEditorResource("Obi/EditorParticle.mat") as Material;
			}
			if (!radiiMaterial) { 
				radiiMaterial = ObiEditorUtils.GetRequiredEditorResource("Obi/EditorParticleRadius.mat") as Material;
			}
		}
 				...
 				if (paintBrush){
					if (ObiClothParticleHandles.ParticleBrush(wsPositions,faceCulling,facingCamera,brushRadius,
															 	()=>{
					                                          	...
					                                          	EditorGUIUtility.Load("Obi/BrushHandle.psd") as Texture2D)){
						ParticlePropertyChanged();
					}
		...
		private bool IsParticleVisible(int index){
			switch(faceCulling){
		...
		void DrawSelectionControls(){
			...
			GUILayout.BeginHorizontal();
			if (GUILayout.Button(new GUIContent(EditorGUIUtility.Load("Obi/InvertButton.psd") as Texture2D,"Invert selection"),GUILayout.MaxHeight(24),GUILayout.Width(42))){
				for(int i = 0; i < selectionStatus.Length; i++){
					if (actor.active[i])
			...
			if (GUILayout.Button(new GUIContent(EditorGUIUtility.Load("Obi/ClearButton.psd") as Texture2D,"Clear selection"),GUILayout.MaxHeight(24),GUILayout.Width(42))){
				for(int i = 0; i < selectionStatus.Length; i++)
			...
			if (GUILayout.Button(new GUIContent(EditorGUIUtility.Load("Obi/InvertPinButton.psd") as Texture2D,"Select fixed"),GUILayout.MaxHeight(24),GUILayout.Width(42))){
				for(int i = 0; i < actor.invMasses.Length; i++){
			...
			selectionBrush = GUILayout.Toggle(selectionBrush,new GUIContent(EditorGUIUtility.Load("Obi/Paint_brush_icon.psd") as Texture2D,"Selection brush"),GUI.skin.FindStyle("Button"),GUILayout.MaxHeight(24),GUILayout.Width(42));
		...
		void DrawPropertyControls(){
			...
			if (GUILayout.Button(new GUIContent(EditorGUIUtility.Load("Obi/FillButton.psd") as Texture2D,"Fill property value"),GUILayout.MaxHeight(24),GUILayout.Width(42))){
			...
			selectionMask = GUILayout.Toggle(selectionMask,new GUIContent(EditorGUIUtility.Load("Obi/MaskButton.psd") as Texture2D,"Selection mask"),GUI.skin.FindStyle("Button"),GUILayout.MaxHeight(24),GUILayout.Width(42));
			
			EditorGUI.BeginChangeCheck();
			textureProperties = GUILayout.Toggle(textureProperties,new GUIContent(EditorGUIUtility.Load("Obi/TextureButton.psd") as Texture2D),GUI.skin.FindStyle("Button"),GUILayout.MaxHeight(24),GUILayout.Width(42));
			if (EditorGUI.EndChangeCheck()){
			...
			EditorGUI.BeginChangeCheck();
			paintBrush = GUILayout.Toggle(paintBrush,new GUIContent(EditorGUIUtility.Load("Obi/PaintButton.psd") as Texture2D,"Paint brush"),GUI.skin.FindStyle("Button"),GUILayout.MaxHeight(24),GUILayout.Width(42));
			if (EditorGUI.EndChangeCheck()){
				if (paintBrush){
			...
			if (paintBrush){
				...
				GUILayout.BeginHorizontal();
				if (GUILayout.Toggle(paintMode == PaintBrushType.Gaussian,new GUIContent(EditorGUIUtility.Load("Obi/GaussianButton.psd") as Texture2D,"Soft brush"),GUI.skin.FindStyle("ButtonLeft"),GUILayout.MaxHeight(28)))
					paintMode = PaintBrushType.Gaussian;
				if (GUILayout.Toggle(paintMode == PaintBrushType.Pencil,new GUIContent(EditorGUIUtility.Load("Obi/PencilButton.psd") as Texture2D,"Pencil"),GUI.skin.FindStyle("ButtonMid"),GUILayout.MaxHeight(28)))
					paintMode = PaintBrushType.Pencil;
				if (GUILayout.Toggle(paintMode == PaintBrushType.Smooth,new GUIContent(EditorGUIUtility.Load("Obi/SmoothButton.psd") as Texture2D,"Smooth"),GUI.skin.FindStyle("ButtonRight"),GUILayout.MaxHeight(28)))
		...
		void DrawFixControls(){
			...
			if (GUILayout.Button(new GUIContent(EditorGUIUtility.Load("Obi/PinButton.psd") as Texture2D,"Fix selected"),GUILayout.MaxHeight(24),GUILayout.Width(42))){
			...
			if (GUILayout.Button(new GUIContent(EditorGUIUtility.Load("Obi/UnpinButton.psd") as Texture2D,"Unfix selected"),GUILayout.MaxHeight(24),GUILayout.Width(42))){
			...
			if (GUILayout.Button(new GUIContent(EditorGUIUtility.Load("Obi/HandleButton.psd") as Texture2D,"Create handle"),GUILayout.MaxHeight(24),GUILayout.Width(42))){
			...
			if (GUILayout.Button(new GUIContent(EditorGUIUtility.Load("Obi/BackfacesButton.psd") as Texture2D,"Show backfaces"),GUI.skin.FindStyle("Button"),GUILayout.MaxHeight(24),GUILayout.Width(42))){
